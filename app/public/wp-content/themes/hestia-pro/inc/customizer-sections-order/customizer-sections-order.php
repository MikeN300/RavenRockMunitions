...
function hestia_sections_customizer_script() {
	wp_enqueue_script( 'hestia_customizer-sections-order-script', get_template_directory_uri() . '/inc/customizer-sections-order/js/customizer-sections-order.js', array( 'jquery', 'jquery-ui-sortable', 'customize-controls' ), HESTIA_VERSION, true );
