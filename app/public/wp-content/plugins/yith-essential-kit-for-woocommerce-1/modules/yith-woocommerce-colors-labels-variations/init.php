<?php
/**
 * Plugin Name: YITH WooCommerce Color and Label Variations
 * Plugin URI: https://yithemes.com/themes/plugins/yith-woocommerce-color-and-label-variations/
 * Description: YITH WooCommerce Color and Label Variations replaces the dropdown select of your variable products with Colors and Labels
 * Version: 1.3.0
 * Author: YITHEMES
...
if ( defined( 'YITH_WCCL_PREMIUM' ) ) {
	function yith_wccl_install_free_admin_notice() {
		?>
		<div class="error">
			<p><?php _e( 'You can\'t activate the free version of YITH WooCommerce Colors and Labels Variations while you are using the premium one.', 'yith-woocommerce-color-label-variations' ); ?></p>
		</div>
	<?php
	}
...
if ( ! defined( 'YITH_WCCL_VERSION' ) ) {
	define( 'YITH_WCCL_VERSION', '1.3.0' );
}
